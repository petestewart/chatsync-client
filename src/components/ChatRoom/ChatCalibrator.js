...

        {
            ...
            ? <div className='calibrator'>
            {
                ...
                ?   <div className="calibrator-form form-group">
                        <label htmlFor="calibrationMessage" className="text-center font-weight-bold">
                            Enter the message you'd like to use to calibrate everyone's chat feed with:
                        </label>
                        ...
                        <div className="mx-3">
                            ...
                            <textarea 
                                ...
                                rows="4" 
                                placeholder="The game clock reaches 15:00" 
                            ...
                            <button className="btn-sm btn-secondary w-100 mt-3" 
                                onClick={() => {
                ...
                :   <div className="calibrator-live text-center">
                        <span className="font-weight-bold">{`${props.calibrationMessage.full_name} `}</span>
                        wants you to click<br/> 
                        <span className="text-danger">'Calibrate NOW'</span> {'when '} <br />
                        ...
                        {/* TODO : ADD KEEP CURRENT OFFSET OPTION
